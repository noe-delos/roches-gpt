...
const SuggestionButton: React.FC<SuggestionButtonProps> = ({
  ...
  <motion.button
    ...
    whileTap={{ scale: 0.97 }}
    className="px-4 py-2 rounded-full bg-[#0A1940]/20 text-[#0A1940] hover:bg-[#0A1940]/10 text-sm flex items-center gap-2"
    onClick={onClick}
  >
...
const SendButton: React.FC<SendButtonProps> = ({
  ...
  <motion.button
    ...
    type={type}
    disabled={disabled}
    className="rounded-full bg-[#0A1940] hover:bg-[#e95136] h-10 w-10 flex items-center justify-center text-white disabled:cursor-not-allowed"
  >
              ...
              <div className="py-20 text-center max-w-4xl mx-auto">
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute left-3 bottom-4 bg-[#0A1940]/20 text-[#0A1940] rounded-full px-3 py-1 flex items-center gap-2 text-sm pointer-events-none">
                      <Image
                        src="/logo-small.png"
                        alt="logo"
                        width={18}
